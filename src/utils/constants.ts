...
// Visible insets applied by panels around the grid (MainPanel, AlbumView, SearchPanel),
// keeping a consistent margin between the rail and the first asset column.
...
// Authored 4K-space px. ri.scale(240) renders a 120 CSS px rail at FHD.
